...
def start_instances():
    ...
    choice = input("\nEnter 'single', 'multiple', or 'all' to start instances: ").strip().lower()
...
def stop_instances():
    ...
    choice = input("\nEnter 'single', 'multiple', or 'all' to stop instances: ").strip().lower()
...
def terminate_instances():
    instances = list_all_instances()  # terminate can show all
    if not instances:
        print("No instances found.")
        return

    choice = input("\nEnter 'single', 'multiple', or 'all' to terminate instances: ").strip().lower()
